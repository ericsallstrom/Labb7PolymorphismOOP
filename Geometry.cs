...
namespace Labb7PolymorphismOOP
{
    ...
    internal abstract class Geometry
    {
        ...
        // den privata _name-variabeln och samtidigt inkrementerar 
        // char-variabeln vid varje nytt objekt som skapas 
        // (dvs. a => b => c osv.) och . Egenskapen har ingen set-funktion
        ...
        // En skyddad metod som underklasserna kan tillämpa
        // för att ta bort "Labb7PolymorphismOOP." från klassnamnet
        // och endast genererar namnet för det geometriska
        // objekt som skapas av respektive klass.
        // Används endast för estetiskt skäl då programmet skriver
        // till konsolen och för att jag ville testa att leka runt
        // med olika sträng-metoder. 
        protected virtual string GetGeometricType()
        {
